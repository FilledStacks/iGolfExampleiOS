...
- (id)initWithTextureFilename:(NSString*)textureFilename andPointList:(PointList*)pointList andWidth:(double)width {
    ...
    startCap = [[CreekCap alloc] initWithPosition:_pointList.firstObject andRadius: width/2];
    endCap = [[CreekCap alloc] initWithPosition:_pointList.lastObject andRadius:width/2];
